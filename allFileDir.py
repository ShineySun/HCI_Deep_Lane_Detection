...
for root, dirs, files in os.walk('/home/foscar/Desktop/bdd/bdd100k/images/100k/test'):
    for fname in files:
        # cnt += 1
        ...
        name = '/home/foscar/Desktop/wireframe/wireframe/data/rgbTest/' + fname[:-4] + '_rgb.png'

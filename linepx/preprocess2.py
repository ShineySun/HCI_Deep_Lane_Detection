...
#         ax.imshow(arr)
       ...
       # ax.axis('off')
        ...
        save_imgname = outPath / "{}{}".format(photo_info['name'][:-4], '_rgb.png')
        lineName = outPath / "{}{}".format(photo_info['name'][:-4],'_line.png')
        lineOrigName = outPath / "{}{}".format(photo_info['name'][:-4],'_line.mat')
